...
* @see app/Http/Controllers/AppointmentController.php:9
...
* @see app/Http/Controllers/AppointmentController.php:62
* @route '/api/appointments/{id}'
*/
...
const AppointmentController = { index, store, update, destroy }
