...
<template>
    <AppLayout :breadcrumbs="breadcrumbs">
        ...
        <SettingsLayout>
            <div class="space-y-6">
                <HeadingSmall title="Autenticación de dos factores"
                ...
                <div v-if="!twoFactorEnabled" class="flex flex-col items-start justify-start space-y-4">
                    ...
                    <p class="text-muted-foreground">
                        Al habilitar la autenticación de dos factores, se te solicitará un pin seguro durante el inicio
                        de sesión. Este pin se puede obtener de una aplicación compatible con TOTP en tu teléfono.
                    </p>
                ...
                <div v-else class="flex flex-col items-start justify-start space-y-4">
                    ...
                    <p class="text-muted-foreground">
                        Con la autenticación de dos factores habilitada, se te solicitará un pin seguro y aleatorio
                        durante el inicio de sesión, que puedes obtener de la aplicación compatible con TOTP en tu
                        teléfono.
                    </p>
