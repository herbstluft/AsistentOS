...
<template>
    <div class="max-w-4xl mx-auto p-6 space-y-6">
        <div>
            <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Suscripción</h1>
            <p class="text-gray-600 dark:text-gray-400 mt-2">Administra tu suscripción y período de prueba</p>
        </div>
            ...
            <CardContent class="space-y-4">
                ...
                <div v-if="subscriptionStatus?.is_on_trial" class="p-6 rounded-xl" :class="{
                    ...
                    <div v-if="isTrialExpiringSoon"
                        ...
                        <AlertCircle class="w-5 h-5 text-orange-600 dark:text-orange-400 flex-shrink-0 mt-0.5" />
                ...
                <!-- Botón de Cancelar -->
                <div v-if="subscriptionStatus?.is_on_trial" class="pt-4 border-t dark:border-gray-700">
                    ...
                    <div v-else class="space-y-3">
                        <div
                            ...
                            <ul class="text-sm text-red-700 dark:text-red-300 space-y-1 ml-4">
                                ...
                                <li>• No se te cobrará nada</li>
                                <li>• Tu sesión se cerrará automáticamente</li>
                            </ul>
                        </div>

                        <div class="flex gap-2">
                            <Button @click="handleCancelTrial" :disabled="loading" variant="destructive" class="flex-1">
                                Sí, cancelar ahora
                            </Button>
            ...
            <CardContent class="space-y-3">
                <div class="flex items-start gap-3">
                    ...
                    <p class="text-sm text-gray-700 dark:text-gray-300">
                        Puedes cancelar tu suscripción en cualquier momento durante el período de prueba sin cargos.
                    </p>
                </div>
                <div class="flex items-start gap-3">
                    <CheckCircle2 class="w-5 h-5 text-green-600 dark:text-green-400 flex-shrink-0 mt-0.5" />
